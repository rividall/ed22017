...
Explicación interactiva: 
 Al correr el programa se generaran unos grupos de cubos que se encuentran rotando 
 ...
 al caer en el agua, pero a la vez el movimiento de los demás objetos esta basado en 
 los movimientos mas bruscos o destructivos que puede generar la misma naturaleza, 
...
Cata [] u = new Cata [6];        // Llamamos a nuestro class.
Cata2 [] d = new Cata2 [3];

float velx, z;                   // Declaramos variables.
