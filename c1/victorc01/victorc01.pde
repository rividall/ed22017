/*Universidad del Desarrollo - Facultad de Diseño - Diseño Digital - 6to semestre - 
 Expresión Digital II -  Certamen 2 - 08.11.2017 - Victor Sartori H.
...
boolean mh, guardarpdf;  // Declaramos modo huracan y guardar en pdf.
...
void draw() {
  ...
  v.modohuracan(); // Activar el modo huracan.
    fill(167, 196, 189); // Verde.
  v.brisa(50, 10, 2, 60); // Crea pequeños circulos al interior del tifón.

    fill(212, 215, 219, 90); // Gris Claro.
...
void mousePressed() {
  mh = !mh; // Cambia el valor del boolean mh, para activar el modo huracan.
}