...
// Francisco Barría
/*
Una flor turquesa que gira en el mismo sentido que los pétalos que están atrás de ella, con una aceleración oscilante.
 Entre estos pétalos hay dos circunferencias que cambia de manera progresiva, pero no suave, su tamaño. Adicionalmente
 hay una malla de círculos en el fondo, que cambian su tamaño en orden progresiva y cíclica.
 */

int x, y, g;                                   //X e Y, funcionan como variables de coordenada. Mientras que g me sirve para las funciones ciclicas.
float l, t, r, s;                              //T, T y R funcionan como variables incrementables, que necesito sean decimales o negativos, y S funciona como la polaridad del movimiento del programa.
boolean w; 
