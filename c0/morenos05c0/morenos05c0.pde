...
/* Dos grillas hecha a partir de cìrculos y cuadrados, se puede cambiar el color celeste por uno naranjo al apretar el mouse. Tambien cambia la cantidad
de los ellipses al mover el mouse con eje Y. Cuando uno utiliza la tecla "z"  se cambia el orden ( aparece menos ) de los ellipses .Cuando uno utiliza
la tecla "x" aumenta un poco mas los ellipses.Cuando uno utiliza la tecla "c" los cuadrados aumentan de tamaño con un fill blanco
y al mover el mouse con eje Y los cuadrados pasa a un degrade  con opacidad.
 */
