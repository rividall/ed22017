...
Universidad del Desarrollo - Facultad de Diseño - Diseño Digital - 6to semestre - Expresión Digital II
 ...
 En la siguiente muestra se le pide al alumno entregar un programa en donde se pueda modificar una grilla por medio de input de mouse y el teclado, y que una vez el 
 programa no reciba input, este tenga un cambio cíclico. Las opciones de modificaciones de la grilla que en este caso el alumno escogió las modificaciones de cantidad de 
 elementos en la grilla, tamaño de la grilla, tamaño y color de los elementos. El resultado de esto se ve de la siguiente manera, se corre el programa y se ve una grilla de
 500 por 500 de ellipses, de color blanco, la cual apretando la tecla "c" se cambia de al color naranjo y luego con la tecla "v" se cambia a verde. Al mismo tiempo con la 
 tecla "x" se agrande el tamaño de las ellipses y con la tecla "z" disminuye. Para poder agrandar o disminuir la grilla se realiza moviendo el cursor del mouse en el eje 
 "x". En ningún caso es necesario dejar presionada la tecla, con tan sólo una vez se puede ver el cambio.
 */
