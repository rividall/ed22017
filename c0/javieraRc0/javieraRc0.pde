...
/* Cuando corra el programa se crearán dos grillas sobre un fondo negro, una con cruces en forma de equis, y una segunda con círculos
 en las zonas donde no hay cruces. Los colores de las grillas inicialmente varían de manera random entre 2 colores, las cruces entre amarillo y blanco
 y los círculos entre blanco y celeste. Las opacidades de ambas grillas están controladas por el movimiento del mouse, Y para las cruces
 y X para los círculos. También los tamaños de las cruces y el ancho del borde de los círculos varía, pero estos son modificados por medio
 del teclado. Siempre que las cruces se vuelvan mas chicas, el borde de los círculos será más grueso, y cuando las cruces sean mas grandes
 lo bordes serán más delgados. Dependiendo de la posición del mouse en el canvas si se puede ver una o las dos grillas y con que intensidad.
 También los colores de los círculos y las cruces pueden variar por medio del teclado, las cruces cambian entre amarillo y naranjo y los
 círculos varían entre celeste y rosado.*/
