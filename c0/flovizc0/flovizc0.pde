...
//-De input de mouse (el click, cambia el color del que ahora podemos llamar cursor, a un color rosado). 
...
//Al mismo tiempo, el programa al no recibir input, este continúa teniendo un cambio cíclico de background aleatorio.
...
void keyPressed(){//En el caso de oprimir una tecla:
  if(key == 't'){//Si se oprime la tecla 't'
    tam += 20;//El tamaño de los cuadrados aumentará en 20, osea 40, por lo que caben la mitad de los cuadrados que cabían anteriormente en el canvas 
