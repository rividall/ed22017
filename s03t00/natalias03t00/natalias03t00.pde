...
color negro; // definir color
color blanco; // definir color
color burdeo; // definir color
color verde; // definir color
color colorpelota2;  //definir color pelota 1
color colorpelota3;  // definir color pelota2
