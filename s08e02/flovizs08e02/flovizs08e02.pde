...
void cuadrados(int x, int y) {
  ...
  fill(c);
  noStroke();
  rect(mouseX, mouseY, numeros[eleccionNumeros], numeros[eleccionNumeros]);
  rect(mouseX, mouseY, x-100, y-100);
  rect(mouseX, mouseY, x-100, y-100);
  rect(mouseX, mouseY, x-100, y-100);
  ...
  fill(c);
  rect(mouseX, mouseY, x+200, y+200);
  rect(mouseX, mouseY, x-50, y-50);
  
  noFill();
  rect(mouseX, mouseY, numeros[eleccionNumeros], numeros[eleccionNumeros]);
  rect(mouseX, mouseY, x+400, y+400);
}
